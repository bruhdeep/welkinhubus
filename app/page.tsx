      ...
      <div className="px-[20%] ">
        ...
        <div className="w-full lg:h-96 bg-[#262626] rounded-2xl lg:flex text-white mt-20">
          <div className="lg:w-[60%] flex justify-center items-center">
            <div className="w-[90%] h-[88%] rounded-xl overflow-hidden bg-white">
              <img
          ...
          <div className="flex items-center pr-4">
            <div>
              ...
              <br />
              <button className="flex gap-2 items-center bg-white px-2 py-1 text-black rounded-xl"><IoCall /> Call now</button>
            </div>
          </div>
        </div>
      </div>
